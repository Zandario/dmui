/mob/verb/themed_example()
	...
	var/buoy_interface/disposal_bin/new_form = new()

	new_form.display_form(src) //? Send usr the form.


/buoy_interface/disposal_bin
...
/buoy_interface/disposal_bin/Initialize()
	pressure = rand(0, 100)
...
/buoy_interface/disposal_bin/get_html_body()
...
/buoy_interface/disposal_bin/get_html_layout()
...
/buoy_interface/disposal_bin/proc/flushClick()
	user << output("You flushed!")

/buoy_interface/disposal_bin/proc/ejectClick()
	user << output("You ejected!") // Suspicious.

/buoy_interface/disposal_bin/proc/pressure_chargingClick()
