/**
 *
 * This was originally written as the Dantom HTML Library.
 * It was later renamed, repurposed, and rewritten to the Zandario DMUI Library.
 *
 * # DMUI Library Releases
 *
 * Version: 2.0   (2023-02-26)
 *
 * # HTML Library Releases
 *
